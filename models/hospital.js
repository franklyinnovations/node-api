    ...
    classMethods : {
      ...
      mongo_update:function(reqData,res){
        var hospitaldetail = Model.hasMany(sequelize.models.hospitaldetail, {foreignKey: 'hospitalId', as: 'hospitaldetail'})
            ...
            var where = {};
                where.hospitaldetail = language.buildLanguageQuery(
                    where.hospitaldetail, req.langId, '`hospital`.`id`', sequelize.models.hospitaldetail, 'hospitalId'
                );
        ...
        Model.find({
          ...
          var save_json_data_in_mongodb = {
            ...
            langId: req.hospitaldetail[0].languageId.toString(),
        ...
        sequelize.query(
              ...
              +" where hospital_doctors.doctorProfileId IN (SELECT hospital_doctors.doctorProfileId FROM `hospital_doctors` where hospital_doctors.hospitalId ="+reqData+")"
              +" GROUP BY hospital_doctors.doctorProfileId"
              +" HAVING count(hospitals.id)=1",
      ...
      filter_hospital : function (req, res) {
        if (typeof req !== 'undefined') {
          ...
          let pageSize = 10, page = req.page, includeObj = [], hospCond = {}, nameFilter = {}, whereHospitalDetailCond = { languageId : req.language.id };
      ...
      unmapdoc : function (req, res) {
        return sequelize.models.hospital_doctors.destroy({
          where: {
