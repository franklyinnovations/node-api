...
function DoctorFeedbacks() {
 ...
 /*
    ...
    this.getDoctorFeedback = function(req, res) {
        ...
        var orderBy = 'id DESC';
        var isWhere = {doctorProfileId: reqData.doctorProfileId}
                    ...
                    include: [
                        {
                            ...
                            include: [
                                {model: models.userdetail, attributes: ["fullname"], where: language.buildLanguageQuery({}, reqData.langId, '`users`.`id`', models.userdetail, 'userId')}
                            ]
                        }
                    ]
                }
